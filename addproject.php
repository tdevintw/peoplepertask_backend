...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `projects`(`project_id`,`project_tittle`,`descreption`,`category_id`,`subcate_id`,`user_id` , `price` )
    VALUES (NULL,'$tittle2','$descreption2','$cate_id2', '$subcate_id2' , '$user_id2' , '$price2')";
