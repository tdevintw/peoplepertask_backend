...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `subcategories`(`subcate_id`,`subcate_name`,`category_id`)
    VALUES (NULL,'$fname2','$id')";
            ...
            <div class="crud_inner">
                ...
                <div class="crud_form">
                    <form action="" method="post">
                        <div>
                            <label for="name">subcate Name:</label>
                            <input type="text" placeholder="subcate name" id="name" name="name">
                        </div>
                        <div>
