...
?>
            ...
            <h1 class="users-header">My Projects:</h1>
            <h2 style="text-align:center;margin-top:100px">You have <span
                    style="color:blue"><?php echo mysqli_num_rows($result) ?></span> Projects</h2>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a
                                    href="update_pclient.php?project_id=<?=$user['project_id']?>&project_tittle=<?=$user['project_tittle']?>&descreption=<?=$user['descreption']?>&price=<?=$user['price']?>"><button
