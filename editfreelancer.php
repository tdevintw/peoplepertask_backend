...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE freelances SET `skills`='$skills' WHERE `freelance_id`='$id' ";
            ...
            <div class="crud_inner">
                ...
                <div class="crud_form">
                    <form action="" method="post" >
                        <div>
                            <label for="name">freelancer_id:</label>
                            <input type="text" placeholder="freelancer id" id="id" name="id">
                        </div>
                        <div>
                            <label for="skills"">skills</label>
                        <input type=" text" placeholder="update skills" id="skills" name="skills">
                        </div>
